...
- `Email` - Email template or sending changes
- `WCCOM/Marketplace` - WooCommerce.com marketplace integration
- `Blocks` - Block editor / Gutenberg related
- `REST API` - API changes (high developer interest)
- `type: community contribution` - Community-contributed PR
- `focus: e2e tests` / `focus: api tests` - Test-related changes
- Team names (Ballade, Rubik, etc.) - Internal team assignments
